...
const url = `mongodb://skaman:${encodeURIComponent('Am@N@sk$2019')}@localhost:6161/skstaging`; // SSH TUNNEL TO LIVE

var option = { "useNewUrlParser": true };
Mongoose.connect(url, option);
const db = Mongoose.connection;

const token = "JWT eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..OK2QPyPaZc4_oPyue-RM-bTaQfb6leKgOKQicsaDubA";
